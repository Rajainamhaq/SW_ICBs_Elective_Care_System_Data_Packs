...
fun_31days_combined_Plot_timeseries <- function(df_cwt_31days_comb) {
###### get max dates for foot note ####
    mon_rtt_date <- df_cwt_31days_comb |>
    ...
    min_y_axis <- min(df_cwt_31days_comb$perf_perc)-0.01
    max_y_axis <- max(df_cwt_31days_comb$perf_perc)+0.01
