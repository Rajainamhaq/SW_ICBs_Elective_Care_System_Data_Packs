...
fun_28days_faster_diag_std_REGION <- function() {
...
df_28days_fds_table <- rbind(RTT_tablet_top10, RTT_table_allother_total, RTT_table_total_pathways )
df_28days_fds_table <- df_28days_fds_table |>
  select(1,3,2,4) |>
