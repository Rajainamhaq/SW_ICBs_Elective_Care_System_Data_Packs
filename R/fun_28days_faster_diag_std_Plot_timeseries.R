...
fun_28days_faster_diag_std_Plot_timeseries <- function(df_cwt_28_fds) {
###### get max dates for foot note ####
    mon_rtt_date <- df_cwt_28_fds |>
    ...
    min_y_axis <- min(df_cwt_28_fds$perf_perc)-0.01
    max_y_axis <- max(df_cwt_28_fds$perf_perc)+0.01
