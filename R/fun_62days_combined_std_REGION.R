...
fun_62days_combined_std_REGION <- function() {
...
df_62days_comb_std_table <- rbind(RTT_tablet_top10, RTT_table_allother_total, RTT_table_total_pathways )
df_62days_comb_std_table <- df_62days_comb_std_table |>
  select(1,3,2,4) |>
  rename(Tumour = Specialty,
         Percent = Utilisation)


######## End of RTT Performance Table creation ###############################

return(df_62days_comb_std_table)
