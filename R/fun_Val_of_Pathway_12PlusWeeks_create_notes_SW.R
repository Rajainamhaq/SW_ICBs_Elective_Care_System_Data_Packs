####################################################################
#### function to create Notes (narrative) for SW ##################
###  Validation of pathways currently waiting 12+ weeks ###########
###################################################################

fun_Val_of_Pathway_12PlusWeeks_create_notes_SW <- function() {
    
  df_provider <- fun_Val_of_Pathway_12PlusWeeks_REGION("South West")
