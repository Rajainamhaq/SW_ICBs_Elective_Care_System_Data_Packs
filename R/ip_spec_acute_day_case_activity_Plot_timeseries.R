...
ip_spec_acute_day_case_activity_Plot_timeseries <- function(ip_spec_acute_final) {
###### get max dates for foot note ####
    ...
    min_y <- floor(min(ip_spec_acute_final$ip_acute_daycase_activty)/500)*500 
    max_y <- ceiling(max(ip_spec_acute_final$ip_acute_daycase_activty)/500)*500 
