####################################################################
#### function to create Notes (narrative) for each Organization ####
###  Validation of pathways currently waiting 12+ weeks ###########
###################################################################

fun_Val_of_Pathway_12PlusWeeks_create_notes_ORG <- function(OrgCode) {
  
  df_provider <- fun_Val_of_Pathway_12PlusWeeks_ORG(OrgCode)
