...
fun_31days_combined_std_ICB <- function(icb_name) {
...
df_31days_comb_std_table <- rbind(RTT_tablet_top10, RTT_table_allother_total, RTT_table_total_pathways )
df_31days_comb_std_table <- df_31days_comb_std_table |>
  select(1,3,2,4) |>
...
return(df_31days_comb_std_table)
